						...
						while (rs.next()) {
							...
							if (rs.getString("email").equals(txtFieldEmail.getText())
								...
								if (rs.getString("status").equals("On Job")) {
									...
									controller.addingData(rs.getString("id"), rs.getString("name"),
...
//                            Decrypt password
							trainerSignInControl.send("mstzsn01@gmail.com", "qazmlp123!", txtFieldEmail.getText(),
									"NutriFit - Password", rs.getString("password"));
